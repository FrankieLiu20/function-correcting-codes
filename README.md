...
| --- | --- | --- |
| `FCC/Paper.lean` | **the main file**: every numbered item of the paper, in paper order, under the paper's section headings | All 65 numbered items are present: Definitions 1–18 stated, 12 of the 17 examples formalized, every theorem/lemma/corollary stated.  **Proved**: `#corollary 1#`, `#theorem 1#`, `#corollary 2#` (§II); `#theorem 2#`, `#theorem 3#`, `#theorem 4#`, `#theorem 5#`, `#corollary 4#`, `#theorem 6#`, `#theorem 7#` (§IV); `#theorem 8#`, `#theorem 9#` (§V-A); plus the non-vacuity bricks.  The rest carry `sorry` (32 in total) |
...
`d_min`, `d(fᵢ,fⱼ)`), 3.1–3.5 (§II: `#corollary 1#`, `#theorem 1#`,
`#corollary 2#`; §IV: `#theorem 2#`, `#theorem 3#`, `#theorem 4#`,
`#theorem 5#`, `#corollary 4#`, `#theorem 6#`, `#theorem 7#`; §V-A:
`#theorem 8#`, `#theorem 9#`) and 3.14 (an FCC always exists) are finished;
everything else carries a `sorry` stub.

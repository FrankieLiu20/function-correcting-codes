...
`d_min`, `d(fᵢ,fⱼ)`), 3.1–3.2 (§II: `#corollary 1#`, `#theorem 1#`,
`#corollary 2#`; §IV: `#theorem 2#`, `#theorem 3#`) and 3.14 (an FCC always
exists) are finished; everything else carries a `sorry` stub.
